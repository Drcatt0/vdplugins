...
const languages = {arabic:"AR",bulgarian:"BG",czech:"CS",danish:"DA",german:"DE",greek:"EL",english:"EN",spanish:"ES",estonian:"ET",finnish:"FI",french:"FR",hungarian:"HU",indonesian:"ID",italian:"IT",japanese:"JA",korean:"KO",lithuanian:"LT",latvian:"LV",norwegian:"NO",dutch:"NL",polish:"PL",portuguese:"PT",romanian:"RO",russian:"RU",slovak:"SK",slovenian:"SL",swedish:"SV",turkish:"TR",ukrainian:"UK","chinese-simplified":"ZH"};
const languageChoices = Object.entries(languages).map(function(e){let[a,i]=e;return{name:a,displayName:a,value:i}});
...
function LanguageSettingsPage() {
    ...
    return t.React.createElement(t.ReactNative.ScrollView, {style: {flex: 1}},
        t.React.createElement(d.Forms.Search, {placeholder: "Search Language", onChangeText: setSearchTerm}),
        languageChoices.filter(choice => choice.name.includes(searchTerm.toLowerCase()))
...
function SettingsPage() {
    ...
    return t.React.createElement(t.ReactNative.ScrollView, {style: {flex: 1}},
        t.React.createElement(d.Forms.FormRow, {
            ...
            trailing: () => t.React.createElement(d.Forms.FormRow.Arrow, null),
            onPress: () => navigation.push("VendettaCustomPage", {title: "Select Language", render: LanguageSettingsPage})
        }),
        t.React.createElement(t.ReactNative.Text, {style: {textAlign: "center", margin: 10}}, "Sample plugin with settings.")
    );
}
