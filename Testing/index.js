...
const searchEngines = {saucenao: "SauceNAO", google: "Google", yandex: "Yandex", tineye: "TinEye"};
const engineChoices = Object.entries(searchEngines).map(function(e){let[a,i]=e;return{name:a,displayName:i}});
